		...
		return (
			<div className="buttonBlockHomepage">
				<Frame
					...
					<div className="innerFrame">
						<Button animate className="button"
							onClick={this.props.onClickERC20} > XRC 20 </Button>

						<div className="list"> {
							this.state.XRC20 && this.state.XRC20.length > 0 && (<div>
								<div className="h4" > Token Created </div>
								<div className="listContainer"> {
									this.state.XRC20.map(item => (<div key={item.address}>
										<Link onClick={() => {
							...
							<div>
								...
								<div >
									<span ><input className="lightInput"
										id="i20"
										onChange={this.onChangeInput}
										placeholder="Contract Address" />&nbsp;</span>
									<span>
				...
				<Frame
					...
					<div className="innerFrame" >
						<Button animate className="button"
							onClick={this.props.onClickERC721} > XRC 721 </Button>

						<div className="list" > {
							this.state.XRC721 && this.state.XRC721.length > 0 && (<div >
								<div className="h4" > Token Created </div>
								<div className="listContainer" > {
									this.state.XRC721.map(item => (<div key={item.address} >
										<Link onClick={() => {
